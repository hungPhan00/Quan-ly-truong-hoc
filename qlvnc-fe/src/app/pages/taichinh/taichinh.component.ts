...
@Component({
  selector: "taichinh",
  templateUrl: "./taichinh.component.html",
  styleUrls: ["./taichinh.component.scss"],
})
export class TaichinhComponent implements OnInit {
  ...
  public searchStudent(key: string): void {
    ...
    for (const studen of this.student) {
      if (
        ...
        studen.ghichu.toLowerCase().indexOf(key.toLowerCase()) !== -1
      ) {
        results.push(studen);
      }
    }
